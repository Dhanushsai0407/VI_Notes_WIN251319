  ...
  useEffect(() => {
    ...
    if (isRecording) {
      interval = setInterval(() => {
        setAnalysisResult(
          AnalysisEngine.analyze(tracker.getLog())
        );
    ...
    <div className="app-container">
      ...
      <div className="sidebar">
        ...
        >
          ...
          >
            Confidential writing session active locally. Data is transmitted
            securely to the backend when you save a session.
          </div>
              ...
              <Editor
                ...
                onSaveSession={async (text) => {
                  ...
                  try {
                    ...
                    alert(
                      'Failed to save session. Please check your backend connection.'
                    );
